      ...
      <main className="relative flex-1">
        <div className="relative mx-auto max-w-[1400px] px-4 pt-4 pb-28">
          <div className="relative aspect-video w-full overflow-hidden rounded-2xl border border-white/10 bg-black shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
            ...
            <video
              ...
              autoPlay
              playsInline
              className={`absolute inset-0 h-full w-full ${peerScreenShareOn ? 'object-contain' : 'object-cover'}`}
            />
            ...
            <div className="pointer-events-auto absolute bottom-4 right-4 w-44 sm:w-56 md:w-64">
              <div className="relative aspect-video overflow-hidden rounded-xl border border-white/10 bg-white/[0.02] shadow-[0_8px_24px_rgba(0,0,0,0.45)]">
                ...
                <div className="absolute bottom-2 left-2 flex items-center gap-2 rounded-md bg-black/60 px-2 py-0.5 text-[11px]">
                  <span>{name || "You"}</span>
                  {screenShareOn && (
                    <span className="inline-flex items-center gap-1 rounded bg-blue-600/80 px-1 py-0.5">
            ...
            {/* Local screenshare preview - smaller preview when sharing */}
            {screenShareOn && (
              <div className="pointer-events-auto absolute top-4 right-4 w-32 sm:w-40 md:w-44">
                <div className="relative aspect-video overflow-hidden rounded-lg border border-blue-500/50 bg-black shadow-[0_4px_16px_rgba(59,130,246,0.3)]">
                  <video
                  ...
                  />
                  <div className="absolute bottom-1 left-1 rounded bg-blue-600/90 px-1 py-0.5 text-[10px] font-medium">
        ...
        <div className="pointer-events-none fixed bottom-6 left-0 right-0 z-50 flex justify-center">
          <div className="pointer-events-auto flex items-center gap-2 rounded-full border border-white/10 bg-black/50 px-2 py-1.5 backdrop-blur">
            ...
            >
              {screenShareOn ? <MonitorStop className="h-5 w-5" /> : <Monitor className="h-5 w-5" />}
            </button>
